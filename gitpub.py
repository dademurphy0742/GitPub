...
def display_repos(title, repos, new_repos=None, newly_cross=None):
    ...
    for r in repos[:10]:
        ...
        table.add_column("Value", style="white", overflow="fold", justify="left", min_width=40)
        ...
        if new_repos and newly_cross:
            t_score = trendiness_score(r, new_repos, newly_cross)
            table.add_row("🔥 Trendiness", str(t_score))
